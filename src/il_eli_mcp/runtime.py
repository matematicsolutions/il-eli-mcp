...
Pulls a tiny static ``il-runtime.json.gz`` from this repo's GitHub Release on
first tool call so a dead endpoint can be repointed (edit runtime/il-runtime.json
...
Opt-out: set ``IL_ELI_RUNTIME_URL=""`` to disable the fetch.
"""
...
MANIFEST_URL = os.environ.get(
    "IL_ELI_RUNTIME_URL",
    "https://github.com/matematicsolutions/il-eli-mcp/releases/latest/download/il-runtime.json.gz",
)
_CACHE_NAME = "il-runtime.json"
_TIMEOUT = 15
_USER_AGENT = "il-eli-mcp-runtime (+https://github.com/matematicsolutions/il-eli-mcp)"
